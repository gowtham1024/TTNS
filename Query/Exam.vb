...
Public Class Exam
    ...
    Private Function generatett()
        ...
        txtsub.Text = " EXAM SCHEDULE FOR TODAY"
        xlid = 1
        ...
        txtbody.Text = " The Following Details Are The Exam TimeTable Schedule for Today (" & Date.Today & ")" & vbNewLine & vbNewLine
    ...
    Private Sub cmbto_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbto.SelectedIndexChanged
        ...
        If flag1 = 1 Then
            generatett()
        ElseIf flag1 = 0 Then
            MsgBox("The exam timetable for  username " & cmbto.Text & " does not exist. Send custom message  ?", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Message")
